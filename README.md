...
- Filtres dynamiques (ex : note minimale, tri)
- Debounce sur les filtres pour éviter le spam API
- Tests unitaires
...
```bash
git clone https://github.com/l-ZaiDev-l/devoir-du----12-11----19-11.git
cd shop-angular--master
```
